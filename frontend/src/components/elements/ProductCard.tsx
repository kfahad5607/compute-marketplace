        ...
        <Card className="w-full max-w-96">
            ...
            <CardContent className="grid gap-4">
                ...
                <div className="text-sm text-muted-foreground">
                    Experience unparalleled performance with this flagship GPU, featuring
                    ray tracing and DLSS for stunning visuals and smooth gameplay.
                </div>
                <div className="grid grid-cols-2 gap-4 mt-2">
                    ...
                    <div className="flex flex-col">
                        ...
                        <span className="text-lg font-semibold text-green-600">$725.50</span>
                    </div>
                </div>
